...
import Context, { callTopUp } from "./context";
// import "./App.scss";
      ...
      {rechargeState && (
        <div className="recharge">
          <div className="recharge-body">
            ...
            <button onClick={() => callTopUp()} style={{color: '#fff', textDecoration: 'underline', cursor: 'pointer', background: 'none', border: 'none', fontSize: '16px'}}>
              Top Up +5000 INR
            </button>
          </div>
        </div>
